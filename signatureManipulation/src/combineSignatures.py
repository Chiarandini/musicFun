...
def split(signature_audio_1: AudioClass, signature_audio_2: AudioClass, method=_split_method_1) -> list:
...
def execute(signature1:SignatureClass, signature2:SignatureClass):
    split_arrays=split(signature1.audio_obj.raw_audio, signature2.audio_obj.raw_audio)
